...
<table align="center" cellpadding="0" cellspacing="0" style="width: 100%;border:1px solid black;margin-bottom: 10px;">
               <tbody>
                  ...
                  <tr>
                     ...
                     <td colspan="3" style=" text-align: right;color:blue;font-style: italic;font-weight: 600;text-decoration: underline;font-size: 25px;">IT STOCK</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;"></td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;color: red;font-style: italic;font-weight: 600;text-decoration: underline;font-size: 25px;"></td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">34 หมู่ 10 ซอยสวนผัก 16 ถนนสุขาภิบาลตลิ่งชัน</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">แขวงตลิ่งชัน เขตตลิ่งชัน กรุงเทพมหานคร 10170</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;">โทรศัพท์: 0-2882-1223</td>
                  </tr>
                  <tr>
                     <td colspan="3" style=" text-align: right;"></td>
                  </tr>
                  ...
                  <tr>
                     <td colspan="2" style="padding: 0px;vertical-align: top;border-right:1px solid black;">
                        <table align="left" cellpadding="0" cellspacing="0" style="border: thin solid black; width: 100%">
                           <tbody>
                              <tr>
                                 <td style="width: 74px;vertical-align: top;color: red;" rowspan="3">ข้อมูลผู้มาติดต่อ, </td>
                     ...
                     <td style="padding: 0px;vertical-align: top;" colspan="3">
                        <table align="left" cellpadding="0" cellspacing="0" style="width: 100%">
                           <tbody>
                              ...
                              <tr>
                                 <td style="border-bottom-style: solid;border-bottom-width: thin;border-bottom-color: black;height: 52px;border-right: 1px solid black;    color: red;">Tax Sell and Service: lorem ipsum</td>
                              </tr>
                           </tbody>
                        </table>
                     </td>
            ...
            $x++;
                ...
                $table.= '
                  ...
                  <tr>
                     ...
                     <td style="border-bottom: 1px solid black;background-color: black;color: white;padding: 5px;-webkit-print-color-adjust: exact;">V.A.T 7%</td>
